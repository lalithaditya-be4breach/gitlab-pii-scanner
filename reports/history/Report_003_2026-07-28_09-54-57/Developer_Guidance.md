...
This developer guidance report accompanies the PII scan of D:\gitlab-pii-scanner. It explains, for each detected issue, why it was flagged and how to fix it -- the risk score and pipeline status themselves are decided exclusively by the deterministic risk engine and are reproduced here for reference only.
...
### F-000001 - CREDIT_CARD [CRITICAL]

- **Location:** .validation_run.py:96
...
### F-000003 - CREDIT_CARD [CRITICAL]

- **Location:** .validation_run.py:117
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-001334 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\REFERENCES.md:473
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-001335 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\REFERENCES.md:494
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-003934 - MEDICAL_LICENSE [CRITICAL]

- **Location:** juice-shop\.github\workflows\lock.yml:20
...
### F-005804 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\challenges.yml:848
- **Category:** Secrets
- **Detection confidence:** 1.0
...
### F-006288 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\data\static\users.yml:22
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-006289 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\data\static\users.yml:26
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-006290 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\data\static\users.yml:58
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-006291 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\data\static\users.yml:82
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-006293 - CREDIT_CARD [CRITICAL]

- **Location:** juice-shop\data\static\users.yml:102
- **Category:** Financial Data
- **Detection confidence:** 1.0
- **Root cause:** A payment card number was committed directly into source, configuration, or test data instead of being handled exclusively by a PCI-compliant payment processor.
- **Likely developer mistake:** Using a real (or realistic) card number for local testing or debugging instead of a card network's published test number range.
...
### F-007719 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectChallenge_1.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-007729 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectChallenge_2.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-007740 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectChallenge_3.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-007751 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectChallenge_4_correct.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-007768 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectCryptoCurrencyChallenge_2.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-007783 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\codefixes\redirectCryptoCurrencyChallenge_4.ts:3
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-008193 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\i18n\ar_SA.json:169
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
### F-008833 - CRYPTO [CRITICAL]

- **Location:** juice-shop\data\static\i18n\az_AZ.json:169
- **Category:** Secrets
- **Detection confidence:** 1.0
- **Root cause:** A cryptocurrency wallet address or private key was committed directly into source instead of being retrieved from secure key storage at runtime.
- **Likely developer mistake:** Pasting a real wallet address or key into code or a config file for convenience during development.
...
...and 89408 more finding(s). See `dashboard.json` for category-level aggregates or the full JSON report for every finding.
